...
usage: python3 tsp_runner.py -dataset youtube pokec livejournal -tile_path run_tiles/ -config_path run_configs/ -csv /home/seonbinara/sgcn_yt_pk_lj.csv -m 0 -u 28 32 60 64 -n 36
"""
...
if __name__ == "__main__":
    ...
    parser.add_argument('-tile_path', required=True, help="Tile files Path")
    ...
    for element in args.dataset:
        if element == "livejournal":
            datasets.append("/home/seonbinara/gnn_data/livejournal.txt")
            datasets_x.append("/home/seonbinara/gnn_data/livejournal_xw.mat")
        elif element == "youtube":
            datasets.append("/home/seonbinara/gnn_data/youtube.txt")
            datasets_x.append("/home/seonbinara/gnn_data/youtube_xw.mat")
        elif element == "pokec":
            datasets.append("/home/seonbinara/gnn_data/pokec.txt")
            datasets_x.append("/home/seonbinara/gnn_data/pokec_xw.mat")
        elif element == "products":
            datasets.append("/home/seonbinara/gnn_data/products.txt")
            datasets_x.append("/home/seonbinara/gnn_data/products_xw.mat")
        elif element == "citation2":
            datasets.append("/home/seonbinara/gnn_data/citation2.txt")
            datasets_x.append("/home/seonbinara/gnn_data/citation2_xw.mat")
        elif element == "orkut":
            datasets.append("/home/seonbinara/gnn_data/orkut.txt")
            datasets_x.append("/home/seonbinara/gnn_data/orkut_xw.mat")
        elif element == "nell":
            datasets.append("/nfs/home/seonbinara/gnn_data/nell.txt")
            datasets_x.append("/nfs/home/seonbinara/gnn_data/nell_xw.mat")
        elif element == "cora":
            datasets.append("/nfs/home/seonbinara/gnn_data/cora.txt")
            datasets_x.append("/nfs/home/seonbinara/gnn_data/cora_xw.mat")
        elif element == "wiki":
            datasets.append("/nfs/home/seonbinara/gnn_data/wiki.txt")
            datasets_x.append("/nfs/home/seonbinara/gnn_data/wiki_xw.mat")
